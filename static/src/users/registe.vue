                           ...
                           <el-radio-group v-model="labelPosition" size="small" v-show="0">
                            ...
                            <el-form :label-position="labelPosition" label-width="150px" :model="formLabelAlign">
                                    ...
                                    <!-- <el-form-item label=" 单笔交易上限：*">
                                        <el-input v-model="userData.once_transfer_amount_limit"></el-input>
                                    </el-form-item> -->
    ...
    methods:{
       ...
       sendMessage(){// 保存修改信息
               this.messageLoading=true;
                ...
                //    sendData.append('once_transfer_amount_limit',this.userData.once_transfer_amount_limit)
                   sendData.append('notify_url',this.userData.notify_url)
                   this.userData.new_password? sendData.append('new_password',this.userData.new_password):'';
